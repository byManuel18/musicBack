...
import { Favorite, FriendRequest, Friends, Playlist, Song, User } from './database/models';
import { DbUtils } from './utils';
import { Schema, Types } from 'mongoose';
import { Status } from './interfaces/friendRequest.interface';
import { ServerApp } from './classes';

// inicializeDB().then(async (e) => {

// const fav = await Friends.create({ user: '649fed80a1198fb8d8ffee0a' });
// console.log(fav);
...
// const sameRequest = await FriendRequest.create({ sender: '649fed80a1198fb8d8ffee0a', receiver: '6491fc1f6f813a68c385b9f0' });
